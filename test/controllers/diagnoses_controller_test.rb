...
class DiagnosesControllerTest < ActionController::TestCase
  ...
  test "should create diagnosis" do
    assert_difference('Diagnosis.count') do
      post :create, diagnosis: { patient_id: @diagnosis.patient_id, position_id: @diagnosis.position_id, resolution_date: @diagnosis.resolution_date }
    end
  ...
  test "should update diagnosis" do
    patch :update, id: @diagnosis, diagnosis: { patient_id: @diagnosis.patient_id, position_id: @diagnosis.position_id, resolution_date: @diagnosis.resolution_date }
    assert_redirected_to diagnosis_path(assigns(:diagnosis))
  end
