...
//       size: Math.round(1.0 * (+placeholder.css("font-size").replace("px", "") || 14)),
...
//       ctx.fillRect(x, posy, LEGEND_BOX_WIDTH, LEGEND_BOX_LINE_HEIGHT - PADDING_BOTTOM);
//       ctx.fillStyle = "#FFF";
//       ctx.fillRect(x + 1, posy + 1, LEGEND_BOX_WIDTH - 2, LEGEND_BOX_LINE_HEIGHT - PADDING_BOTTOM - 2);
//       ctx.fillStyle = s.color;
//       ctx.fillRect(x + 2, posy + 2, LEGEND_BOX_WIDTH - 4, LEGEND_BOX_LINE_HEIGHT - PADDING_BOTTOM - 4);
//       posx = x + LEGEND_BOX_WIDTH + PADDING_RIGHT;
//       posy = posy + f.size + 2;
